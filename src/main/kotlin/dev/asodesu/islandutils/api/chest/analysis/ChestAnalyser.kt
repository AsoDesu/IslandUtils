...
interface ChestAnalyser {
    ...
    fun render(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, helper: ContainerScreenHelper) {}
    fun renderSlotFront(guiGraphics: GuiGraphics, helper: ContainerScreenHelper, slot: Slot) {}
    fun renderSlotBack(guiGraphics: GuiGraphics, helper: ContainerScreenHelper, slot: Slot) {}
