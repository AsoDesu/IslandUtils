...
public class Scavenging {
    ...
    // the offset between the end of the scavenging icons and the right-side of the
    // body
    ...
    public static void setTitleCharacter(String titleCharacter) {
        Scavenging.titleComponent = Component.literal(titleCharacter).withStyle(
                Style.EMPTY.withColor(ChatFormatting.WHITE)
                        .withFont(ResourceLocation.fromNamespaceAndPath("mcc", "chest_backgrounds")));
    }
}